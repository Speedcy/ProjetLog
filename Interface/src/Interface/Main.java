...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * Vector<Double> position1 =new Vector<Double>(2); position1.add(50.0);
		 * position1.add(50.0); Vector<Double> position2 =new Vector<Double>(2);
		 * position2.add(41.0); position2.add(40.0); Vector<Double> vitesse =new
		 * Vector<Double>(2); vitesse.add(2.0); vitesse.add(0.0); ParticuleChargee p1 =
		 * new ParticuleChargee(position1,vitesse, 1.6*Math.pow(10,
		 * -19),9.1*Math.pow(10, -1)); ParticuleChargee p2 = new
		 * ParticuleChargee(position2,vitesse, 1.6*Math.pow(10, -19),9.1*Math.pow(10,
		 * -1));
		 * 
		 ...
		 * 
		 * 
		 * Simulateur simulateur = new Simulateur(); simulateur.addParticule(p1);
		 ...
		 * 
		 * @Override public void run() { Fenetre ex = new Fenetre(simulateur);
		 * ex.setVisible(true); } });
		 */
